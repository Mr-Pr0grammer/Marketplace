...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        ...
        {"name": "Shop", "url": f"{CORS_ALLOWED_ORIGINS[2]}", "new_window": True},
    ...
    "icons": {
        ...
        "shop.productcart": "fas fa-shopping-cart",
        "users.usercomplaint": "fas fa-exclamation-circle",
    },
